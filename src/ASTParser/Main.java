...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Create a new folder
        String folderPath = "/Users/apple/NetBeansProjects/ParseJavaFile/output/ASTParser-" + timeStampStr + "/";
        createDir(folderPath);
        
        File inputRootFile = new File("/Users/apple/NetBeansProjects/ParseJavaFile/sourceCode");
